...
const updateWalkinPatients= async (req, res) => {
    ...
    try {
        let reportDocument;
        let patient = await WalkinPatient.findById(patientId);
        ...
        if(patient.labReportId){
            ...
            if(reportDocument){
                if(reportNumbers !== 'null'){
                    ...
                    patient = await WalkinPatient.findByIdAndUpdate(
                        patientId,
                        {
                          $unset: { labReportId: "" }
                        },
...
module.exports = { updateWalkinPatients };